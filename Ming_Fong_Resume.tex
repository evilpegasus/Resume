...
\definecolor{darkblue}{rgb}{0.04,0,0.64}
...
\begin{rSubsection}{Balyasny Asset Management LP}{Summer 2023}{Quantitative Research Intern}{New York City, NY}
    \item Equities alternative data and fundamentals feature research
\end{rSubsection}
% \vspace{-1.35em}  % For empty job sections

\begin{rSubsection}{Google DeepMind}{September 2022 - December 2022}{Core Research Engineering Intern}{London, UK}
...
\begin{rSubsection}{\href{https://www.kaggle.com/evilpegasus}{Kaggle Data Science Competitions Expert}}{}{}{}
    \item Kaggle data science Competitions Expert with a peak global rank of 1144 (top 0.5\%)
...
%     \item Quantified the effectiveness of government interventions on COVID-19 rates in Europe using linear models in Python
% \end{rSubsection}
