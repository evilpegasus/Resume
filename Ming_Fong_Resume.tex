...
\begin{rSection}{Education}
    \begin{rSubsection}{University of California, Berkeley}{June 2020 – May 2023}{Bachelor of Arts, Physics and Computer Science}{Berkeley, CA}
        ...
        \item {\bf Activities:} Student Association for Applied Statistics (SAAS), Traders at Berkeley
        \end{rSubsection}
    \end{rSection}
...
\item Implemented deep learning techniques for pion identification problems with the ATLAS detector at CERN
\item Researched models for classification of pions with 5+ times better background rejection than hand-tuned models
\end{rSubsection}
